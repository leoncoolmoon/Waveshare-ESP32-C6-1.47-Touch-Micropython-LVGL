...
indev = axs5106.AXS5106(touch_i2c, startup_rotation=lv.DISPLAY_ROTATION._0, 
...
class TouchMouseUI:
    def __init__(self, width, height, ble_mouse):
        ...
        self.canvas_height = height - self.btn_height - self.margin * 3
        self.create_canvas()
    ...
    def create_buttons(self):
        ...
        self.btn_left.set_size(btn_width, self.btn_height - 5)
        self.btn_left.set_pos(start_x, 3)
        ...
        self.btn_middle.set_size(btn_width, self.btn_height - 5)
        self.btn_middle.set_pos(start_x + btn_width + btn_spacing, 3)
        ...
        self.btn_right.set_size(btn_width, self.btn_height - 5)
        self.btn_right.set_pos(start_x + (btn_width + btn_spacing) * 2, 3)
    ...
    def draw_scroll_indicator(self):
        ...
        for i in range(-8, 9, 2):
            self.canvas.set_px(cx + i, cy - 12, lv.color_hex(0x4488ff), lv.OPA.COVER)
            self.canvas.set_px(cx + i, cy + 12, lv.color_hex(0x4488ff), lv.OPA.COVER)
        
        # 画左右箭头（水平滚轮指示）
        for i in range(-8, 9, 2):
            self.canvas.set_px(cx - 12, cy + i, lv.color_hex(0x4488ff), lv.OPA.COVER)
            self.canvas.set_px(cx + 12, cy + i, lv.color_hex(0x4488ff), lv.OPA.COVER)
    
    def create_status_indicator(self):
        """创建连接状态指示器（左上角）"""
        self.status_led = lv.obj(self.scrn)
        self.status_led.set_size(10, 10)
        self.status_led.set_pos(self.margin + 2, 5)
        self.status_led.set_style_radius(5, 0)
    ...
    def create_mode_indicator(self):
        ...
        self.mode_led.set_size(10, 10)
        self.mode_led.set_pos(self.width - self.margin - 12, 5)
        self.mode_led.set_style_radius(5, 0)
        ...
        self.mode_label.set_pos(self.width - self.margin - 28, 3)
